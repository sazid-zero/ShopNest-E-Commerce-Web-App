...
function Products() {
    ...
    // Filters
    const [sortOrder, setSortOrder] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("latest");
    ...
    const [selectedType, setSelectedType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(type || "all");
    const [selectedCategory, setSelectedCategory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(categoryQuery || "all");
                        ...
                        if (res.ok) {
                            ...
                            if (data.length > 0) {
                                const max = Math.max(...data.map({
                                    "Products.useEffect.fetchProducts.max": (p)=>p.price
                                }["Products.useEffect.fetchProducts.max"]));
                                setPriceRange([
                                    0,
                                    max
                                ]);
    ...
    const uniqueTypes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Products.useMemo[uniqueTypes]": ()=>[
                "all",
                ...Array.from(new Set(products.map({
                    "Products.useMemo[uniqueTypes]": (p)=>p.type
                }["Products.useMemo[uniqueTypes]"]).filter({
                    "Products.useMemo[uniqueTypes]": (t)=>typeof t === 'string' && t.length > 0
                }["Products.useMemo[uniqueTypes]"])))
            ]
    }["Products.useMemo[uniqueTypes]"], [
        products
    ...
    const uniqueCategories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Products.useMemo[uniqueCategories]": ()=>[
                "all",
                ...Array.from(new Set(products.map({
                    "Products.useMemo[uniqueCategories]": (p)=>p.category
                }["Products.useMemo[uniqueCategories]"]).filter({
                    "Products.useMemo[uniqueCategories]": (c)=>typeof c === 'string' && c.length > 0
                }["Products.useMemo[uniqueCategories]"])))
            ]
    }["Products.useMemo[uniqueCategories]"], [
        products
    ...
    const filteredAndSortedProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Products.useMemo[filteredAndSortedProducts]": ()=>{
            let result = products.filter({
                "Products.useMemo[filteredAndSortedProducts].result": (product)=>{
                    const matchesType = selectedType === "all" || product.type === selectedType;
                    const matchesCategory = selectedCategory === "all" || product.category === selectedCategory;
                    const matchesPrice = product.price >= priceRange[0] && product.price <= priceRange[1];
                    return matchesType && matchesCategory && matchesPrice;
                }
            }["Products.useMemo[filteredAndSortedProducts].result"]);
            switch(sortOrder){
                case "price-asc":
                    result.sort({
                        "Products.useMemo[filteredAndSortedProducts]": (a, b)=>a.price - b.price
                    }["Products.useMemo[filteredAndSortedProducts]"]);
                    break;
                case "price-desc":
                    result.sort({
                        "Products.useMemo[filteredAndSortedProducts]": (a, b)=>b.price - a.price
                    }["Products.useMemo[filteredAndSortedProducts]"]);
                    break;
                case "name-asc":
                    result.sort({
                        "Products.useMemo[filteredAndSortedProducts]": (a, b)=>a.title.localeCompare(b.title)
                    }["Products.useMemo[filteredAndSortedProducts]"]);
                    break;
                case "name-desc":
                    result.sort({
                        "Products.useMemo[filteredAndSortedProducts]": (a, b)=>b.title.localeCompare(a.title)
                    }["Products.useMemo[filteredAndSortedProducts]"]);
                    break;
                default:
                    result.sort({
                        "Products.useMemo[filteredAndSortedProducts]": (a, b)=>b.id - a.id
                    }["Products.useMemo[filteredAndSortedProducts]"]); // Latest
            }
            return result;
        }
    }["Products.useMemo[filteredAndSortedProducts]"], [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-2",
                                        children: uniqueCategories.map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-2",
                                        children: uniqueTypes.map((t)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(Products, "jZKRiGDJaVXT8MWTnjofWzRBPeE=", false, function() {
    return [
...
//# sourceMappingURL=_dba7e3b3._.js.map