...
async function POST(req) {
    try {
        ...
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].connect();
        try {
            const res = await client.query(`INSERT INTO products (name, price, original_price, discount, stock, description, image_url, category_id, shop_id, type)
         ...
         RETURNING *`, [
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(res.rows[0]);
        } finally{
            client.release();
        }
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3736e862._.js.map