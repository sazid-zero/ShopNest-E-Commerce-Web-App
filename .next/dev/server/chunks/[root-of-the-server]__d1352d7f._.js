...
async function GET() {
    try {
        ...
        try {
            const result = await client.query("SELECT * FROM banners WHERE is_active = TRUE ORDER BY position ASC");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d1352d7f._.js.map